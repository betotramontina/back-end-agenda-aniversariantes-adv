...
def apresenta_contatos(contatos: List[Contato]):
    """ Converte uma lista de objetos do modelo Contato para uma representação compatível
        com o esquema definido em ListagemContatosSchema.
    """
    result = []
...
def apresenta_contato(contato: Contato):
    """ Converte um objeto do modelo Contato para uma representação compatível 
        com o esquema definido em ContatoViewSchema.
    """
    return {
        "id": contato.id,
        "nome": contato.nome,
